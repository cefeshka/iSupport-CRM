/*
  # Fix Bonus Function Email Reference
  
  Updates the function to correctly handle technician name:
  - Use full_name from profiles (no email fallback since it's not in profiles)
  - Join with auth.users to get email if needed
*/
